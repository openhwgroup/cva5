...
VL_ATTR_COLD void Vtaiga_sim_fp_register_file_issue_interface___ctor_var_reset(Vtaiga_sim_fp_register_file_issue_interface* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtaiga_sim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtaiga_sim_fp_register_file_issue_interface___ctor_var_reset\n"); );
    // Body
    ...
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
        vlSelf->data[__Vi0] = VL_RAND_RESET_Q(64);
    }
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
