...
VL_ATTR_COLD void Vtaiga_sim_ras_interface___ctor_var_reset(Vtaiga_sim_ras_interface* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtaiga_sim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtaiga_sim_ras_interface___ctor_var_reset\n"); );
    // Body
