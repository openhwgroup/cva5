...
VL_ATTR_COLD void Vtaiga_sim_fifo_interface__D12___ctor_var_reset(Vtaiga_sim_fifo_interface__D12* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtaiga_sim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                  Vtaiga_sim_fifo_interface__D12___ctor_var_reset\n"); );
    // Body
