...
#include "Vfp_div_simulation_wrapper.h"
#include "unit_test.h"
...
unit_test<Vfp_div_simulation_wrapper, ull, double> *unit_test_inst;
...
int main(int argc, char ** argv) {
    ...
    unit_test_inst = new unit_test<Vfp_div_simulation_wrapper, ull, double>(argv[1], input_count, argv[4]);
    #ifdef TRACE_ON
